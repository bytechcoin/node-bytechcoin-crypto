...
```bash
npm install bytechcoin-crypto
```

## Intialization

```javascript
const BytechCoinCrypto = require('bytechcoin-crypto')
```
...
const valid = BytechCoinCrypo.checkKey(publicKey)
```
...
const valid = BytechCoinCrypo.checkSignature(
...
const publicKey = BytechCoinCrypto.derivePublicKey(
...
const secretKey = BytechCoinCrypto.deriveSecretKey(
...
const derivation = BytechCoinCrypto.generateKeyDerivation(secretKey, publicKey)
```
...
const secretKey = 
  '7bd90a13b4039743744682899dc61a7317b5ceced01d695cdeae6409cdc70803'
const keyImage = BytechCoinCrypto.generateKeyImage(publicKey, secretKey)
```
...
```javascript
const keys = BytechCoinCrypo.generateKeys()
```
...
const publicKey = BytechCoinCrypto.secretKeyToPublicKey(secretKey)
```
...
const signatures = BytechCoinCrypto.generateRingSignatures(
...
const secretKey = 
  'cfaeecf3bd68746b27826769b621b52518a9bed2c9ae46c97ac26a7d2b72110e'
const signature = BytechCoinCrypo.generateSignature(
...
const derivedKey = 
    'bb55bef919d1c9f74b5b52a8a6995a1dc4af4c0bb8824f5dc889012bc748173d'
const publicKey = BytechCoinCrypto.underivePublicKey(
...
const hash = BytechCoinCrypto.cnFastHash(data)
```
...
## cn_bytech_lite_slow_hash_v0(data)

Performs the cn_bytech_lite_slow_hash_v0 function against the data

```javascript
const data =
  '0100fb8e8ac805899323371bb790db19218afd8db8e3755d8b90f39b3d5506a9abce4fa912244500'
const hash = BytechCoinCrypto.cn_bytech_lite_slow_hash_v0(data)
```
...
## cn_bytech_lite_slow_hash_v1(data)

Performs the cn_bytech_lite_slow_hash_v1 function against the data
...
const hash = BytechCoinCrypto.cn_bytech_lite_slow_hash_v1(data)
```
...
## cn_bytech_lite_slow_hash_v2(data)

Performs the cn_bytech_lite_slow_hash_v2 function against the data
...
const data =
  '0100fb8e8ac805899323371bb790db19218afd8db8e3755d8b90f39b3d5506a9abce4fa912244500323443'
const hash = BytechCoinCrypto.cn_bytech_lite_slow_hash_v2(data)
```
